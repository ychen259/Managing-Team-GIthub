    ...
    describe('Duc results controller test', function () {
      ...
      describe('sendEmail function Fail', function () {
        ...
        it('send Notification error message', function () {
          expect(Notification.error).toHaveBeenCalledWith({message: 'Try again later!', title: '<i class="glyphicon glyphicon-remove"></i> Failed to send result email!', delay: 4000 });
        });
      });
